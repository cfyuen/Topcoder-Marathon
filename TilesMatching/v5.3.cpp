...
*/
FILE *debug,*result;
int debugmsg=0,localtest=1,st=2001,end=3000;
   ...
   public:
      ...
      double score4 (int inits) {
         ...
         for (int i=0; i<cons; i++) {
             ...
             //fprintf(stderr,"%d: %d %0.4lf   %d: %d %0.4lf\n",row[i].second,cros1,(-row[i].first),col[i].second,cros2,(-col[i].first));
             }
...
int main () {
    ...
    MersenneTwister r;
    result=fopen("result v5.32.txt","w");
