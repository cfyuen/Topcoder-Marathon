...
class BounceOff {
   public:
      vector <string> placeObstacles(vector <int> oX, vector <int> oY, int R) {
         ...
         for (int i=0; i<tar.size(); i++) {
             //number of segments
             aim[i*segment].x1=(int)tar[i].x; aim[i*segment].y1=(int)tar[i].y-R; aim[i*segment].x2=(int)tar[i].x; aim[i*segment].y2=(int)tar[i].y+R;
             aim[i*segment+1].x1=(int)tar[i].x-R; aim[i*segment+1].y1=(int)tar[i].y; aim[i*segment+1].x2=(int)tar[i].x+R; aim[i*segment+1].y2=(int)tar[i].y;
             aim[i*segment+2].x1=(int)tar[i].x-R; aim[i*segment+2].y1=(int)tar[i].y; aim[i*segment+2].x2=(int)tar[i].x; aim[i*segment+2].y2=(int)tar[i].y-R;
             aim[i*segment+3].x1=(int)tar[i].x+R; aim[i*segment+3].y1=(int)tar[i].y; aim[i*segment+3].x2=(int)tar[i].x; aim[i*segment+3].y2=(int)tar[i].y-R;
             //fprintf(debug,"(%d %d)\n",(int)tar[i].x,(int)tar[i].y);
             //fprintf(debug,"%d %d -> %d %d\n",aim[i*2+3].x1,aim[i*2+3].y1,aim[i*2+3].x2,aim[i*2+3].y2);
             }
