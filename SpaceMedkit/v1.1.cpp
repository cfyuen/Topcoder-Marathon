...
Total mass = 42.0233     Total volume = 123677.2315     Score = 115.3447
Score = 8.6697

Seed = 2
Total evacuations = 63     Limit = 124
Total mass = 61.8237     Total volume = 177687.0985     Score = 161.1495
Score = 6.2054

Seed = 3
Total evacuations = 271     Limit = 300
Total mass = 61.4133     Total volume = 176870.6169     Score = 83.2775
Score = 12.0080

Seed = 4
Total evacuations = 350     Limit = 451
Total mass = 46.4069     Total volume = 129473.4827     Score = 68.5194
Score = 14.5944

Seed = 5
Total evacuations = 53     Limit = 237
Total mass = 61.7776     Total volume = 177663.6845     Score = 160.8534
Score = 6.2168

Seed = 6
Total evacuations = 228     Limit = 249
Total mass = 42.8061     Total volume = 126667.2171     Score = 122.5919
Score = 8.1571

Seed = 7
Total evacuations = 388     Limit = 115
Evacuation exceeds!!
Score = 0

Seed = 8
Total evacuations = 53     Limit = 101
Total mass = 63.7362     Total volume = 181816.0475     Score = 113.6963
Score = 8.7954

Seed = 9
Total evacuations = 384     Limit = 424
Total mass = 14.5102     Total volume = 54253.3907     Score = 67.8459
Score = 14.7393

Seed = 10
Total evacuations = 340     Limit = 468
Total mass = 46.4069     Total volume = 129473.4827     Score = 60.4464
Score = 16.5436
*********/
...
vector<pair<double,pair<vector<PII>,vector<int> > > > handle;
...
class SpaceMedkit {
   public:
      ...
      void phrase1 () {
         ...
         for (int i=0; i<handle.size(); i++) {
             ...
             for (int j=0; j<handle[i].second.first.size(); j++) {
                 ...
                 for (int k=0; k<req.size(); k+=2)
                     if (keyres[(int)req[k]]==1) {//optimize, only consider key resources
         ...
         //for (int i=0; i<18000; i++) {
             ...
             for (int j=0; j<usedres.size(); j++) {
                 if (curruse[usedres[j]]<need[usedres[j]] && nowcost>60)
                    if ( ((need[usedres[j]]-curruse[usedres[j]])*rcost[usedres[j]])>40 ) {
                       additem=0;
      ...
      vector <string> getMedkit(vector <string> ar, vector <string> rr, vector <string> mis, double _P, double _C) {
         ...
         cntop=0;
         P=_P; C=_C;
         alluntreat=0; noofmis=0; nowcost=0;
